...
def upload_screenshot_view(path):
    ...
    text = extract_text_from_image(path, "Respond Interactively, Solve or recognise the problem and give me the final answer using normal math symbols(√, π, ∫, etc.) in plain text, without LaTeX code, bold letters or \\boxed{} formatting .")
    print(text)
    return text
